...
import { Attachment, CardAction, CardActionTypes } from 'botframework-directlinejs-modified';
...
export const AttachmentView = (props: {
    ...
    <ul className="wc-card-buttons">
        { buttons.map((button, index) => {
          ...
          return(
            <li key={ index }><button className={className} onClick={ onCardAction(button) }>{ button.title }</button></li>
          )
        })
      }
    </ul>;
