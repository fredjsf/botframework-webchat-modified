...
import { Activity, Media, IBotConnection, User, MediaType, DirectLine, DirectLineOptions, CardActionTypes } from 'botframework-directlinejs-modified';
...
export const doCardAction = (
    ...
    from: User,
    locale: string,
    sendMessage: (value: string, user: User, locale: string, title:string) => void,
): IDoCardAction => (
    type,
    actionValue,
    title
