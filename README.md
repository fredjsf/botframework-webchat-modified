Modified version of the official MS Botframework-webchat v0.10.7, some changes:
...
* 'window.enableOldButtons' to set enable/disable old buttons, default to false
* 'window.lastIndexDisableButtons' to configure which new buttons to be enabled, e.g. if set to 2, only the last 2 message bubble buttons will be enabled
