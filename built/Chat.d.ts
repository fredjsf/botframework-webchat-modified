...
export declare const sendMessage: (text: string, from: User, locale: string, title?: string) => ChatActions;
...
export declare const doCardAction: (botConnection: IBotConnection, from: User, locale: string, sendMessage: (value: string, user: User, locale: string, title: string) => void) => IDoCardAction;
