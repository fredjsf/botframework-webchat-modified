...
exports.AttachmentView = function (props) {
    ...
    var onCardAction = function (cardAction) {
        return cardAction &&
            (function (e) {
    ...
    var buttons = function (buttons) { return buttons &&
        React.createElement("ul", { className: "wc-card-buttons" }, buttons.map(function (button, index) {
            //assign a class to the button
            var className = '';
            if (button.type == 'postBack' || button.type == 'imBack') {
                className = 'postBack';
            }
            ...
            return (React.createElement("li", { key: index },
                React.createElement("button", { className: className, onClick: onCardAction(button) }, button.title)));
        })); };
