...
var botframework_directlinejs_modified_1 = require("botframework-directlinejs-modified");
var Store_1 = require("./Store");
var react_redux_1 = require("react-redux");
exports.sendMessage = function (text, from, locale, title) {
    return {
        type: 'Send_Message',
        activity: {
            type: "message",
...
var Chat = (function (_super) {
    ...
    Chat.prototype.componentDidMount = function () {
        ...
        var botConnection = this.props.directLine
            ? (this.botConnection = new botframework_directlinejs_modified_1.DirectLine(this.props.directLine))
...
exports.Chat = Chat;
exports.doCardAction = function (botConnection, from, locale, sendMessage) { return function (type, actionValue, title) {
    var text = (typeof actionValue === 'string') ? actionValue : undefined;
    var value = (typeof actionValue === 'object') ? actionValue : undefined;
    switch (type) {
        case "imBack":
            //imback already as payload here
            if (typeof text === 'string')
                sendMessage(text, from, locale, title);
            break;
        case "postBack":
